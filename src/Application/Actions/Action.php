...
abstract class Action
{
    ...
    {
        $payload = new ActionPayload($data['status'], $data['message']);
     ...
     * @return mixed
     */
    protected function getRequestBody(bool $associative = true)
    {
        return json_decode($this->request->getBody()->getContents(), $associative);
    }
