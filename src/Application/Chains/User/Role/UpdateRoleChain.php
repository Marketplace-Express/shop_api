...
use App\Application\Handlers\User\Role\UpdateRole;
...
class UpdateRoleChain extends AbstractChain
{
    /**
    ...
    public function initiate()
    {
        ...
        $handlers
            ...
            ->next(new UpdateRole($this->requestSender));
