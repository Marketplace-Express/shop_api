...
use App\Application\Handlers\User\Role\UnAssignRole;
...
class UnAssignRoleChain extends AbstractChain
{
    /**
    ...
    public function initiate()
    {
        ...
        $handlers
            ...
            ->next(new UnAssignRole($this->requestSender));
