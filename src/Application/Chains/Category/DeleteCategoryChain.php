...
use App\Application\Handlers\Category\DeleteCategory;
...
class DeleteCategoryChain extends AbstractChain
{
    /**
    ...
    /**
     * DeleteCategoryChain constructor.
    ...
    public function initiate()
    {
        ...
        $handlers
            ...
            ->next(new DeleteCategory($this->requestSender));
