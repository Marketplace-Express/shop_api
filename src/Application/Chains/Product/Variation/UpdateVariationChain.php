...
use App\Application\Handlers\Product\Variation\UpdateVariation;
...
class UpdateVariationChain extends AbstractChain
{
    /**
    ...
    /**
     * UpdateVariationChain constructor.
    ...
    public function initiate()
    {
        ...
        $handlers
            ...
            ->next(new UpdateVariation($this->requestSender));
